        ...
        <div className=" flex justify-between bg-gray-400 w-full p-2 shadow">
            <div className="">
                <ul className="flex gap-3">
                    <li className="px-4 py-1 bg-white rounded cursor-pointer" onClick={() => { navigate("/") }}>HOME</li>
                    <li className="px-4 py-1 bg-white rounded cursor-pointer" onClick={() => { navigate("/insert") }}>INSERT</li>
                    <li className="px-4 py-1 bg-white rounded cursor-pointer" onClick={() => { navigate("/reports") }}>Reports</li>
                    <li className="px-4 py-1 bg-white rounded cursor-pointer" onClick={() => { navigate("/robots") }}>ROBOTS</li>
                </ul>
            </div>
